      ...
      <div className='text-center'>
        ...
        <p className='mt-1 text-body text-dark-700'>
          {mode === "sign-in"
            ...
            : "Create your account to start your fittnes journey"}
        </p>
      </div>
        ...
        {mode === "sign-up" && (
          <div className='space-y-1'>
            ...
            <input
              ...
              className='w-full rounded-xl border border-light-100 px-4 py-3 text-body text-dark-900 placeholder:text-dark-500 focus:outline-none focus:ring-2 focus:ring-dark-900/10'
              autoComplete='name'
            />
          </div>
        )}
